...
if ($screen->id == 'toplevel_page_dreamobjects-menu') {
    ...
    $screen->add_help_tab( array(
		...
		'content' => 
		'<h3>' . __('Welcome to Object Store Backups', 'dreamobjects') .'</h3>' .
		'<p>' . __( 'Object storage service provides a reliable, flexible cloud storage solution for entrepreneurs and developers. It provides a perfect, scalable storage solution for your WordPress site.', 'dreamobjects' ) . '</p>'
		));
